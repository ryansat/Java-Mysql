...
PreparedStatement pst = null;
    ...
    {
         try {
            String sql = "SELECT DISTINCT c.NAMA_BARANG,b.ID_BARANG,b.JUMLAH,a.ID_PENJUALAN,a.ID_PEGAWAI,a.ID_CUSTOMER,\n" +
"a.TANGGAL_TRANSAKSI,d.HARGA,b.HARGA,a.KURS,(b.`JUMLAH`*d.`HARGA`) \"Sub Total\"\n" +
"FROM transaksi a\n" +
"JOIN dimiliki b ON (a.ID_PENJUALAN = b.ID_PENJUALAN)\n" +
"JOIN barang c ON (b.`ID_BARANG` = c.`ID_BARANG`)\n" +
"JOIN dimiliki d ON (d.`ID_BARANG` = c.`ID_BARANG`)\n" +
"GROUP BY a.`TANGGAL_TRANSAKSI`";
