 ...
 * @author Fajar
 */
public class Pembatalan_Transaksi extends javax.swing.JInternalFrame {
Connection conn = null;
ResultSet rs = null;
PreparedStatement pst = null;
    /**
     * Creates new form Pembatalan_Transaksi
     */
    public Pembatalan_Transaksi() {
        initComponents();
                 try {
    ...
    void batal1() 
    {
        ...
        if(dialogResult==0){
            String sql = "DELETE FROM transaksi WHERE id_penjualan=?";
            try {
                pst = conn.prepareStatement(sql);
    ...
    void batal2() 
    {
         String sql = "DELETE FROM dimiliki WHERE id_penjualan=?";
            try {
                pst = conn.prepareStatement(sql);
                pst.setString(1, id_dist.getText());
                pst.execute();
